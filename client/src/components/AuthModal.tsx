...
export default function AuthModal({ isOpen, onClose, initialType }: AuthModalProps) {
    ...
    try {
      if (type === 'signup') {
        ...
        toast({
          ...
          description: "Welcome to InterviewGenie",
        });
      } else {
        await signInWithEmail(formData.email, formData.password);
        toast({
          title: "Signed in successfully!",
          description: "Welcome back to InterviewGenie",
        });
      }
      onClose();
    } catch (error: any) {
