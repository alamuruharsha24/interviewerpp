...
// Top tech companies for DSA question generation
export const TOP_COMPANIES = [
  'Google', 'Microsoft', 'Amazon', 'Apple', 'Meta (Facebook)',
  'Netflix', 'Tesla', 'Uber', 'Airbnb', 'LinkedIn',
  'Salesforce', 'Adobe', 'Intel', 'NVIDIA', 'PayPal',
  'Spotify', 'Dropbox', 'Twitter', 'Snap', 'Pinterest',
  'Atlassian', 'Shopify', 'Square', 'Stripe', 'Coinbase'
];
