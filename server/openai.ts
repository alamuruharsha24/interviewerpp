...
export async function generateDSAQuestions(): Promise<DSAQuestion[]> {
  // Always return fallback questions since we have a comprehensive set
  // This ensures the DSA section works regardless of API key configuration
  console.log("Using curated DSA questions (32 questions covering all major topics)");
